...
//        SQLiteDatabase db = mDbHelper.getReadableDatabase();
    ...
    private void displayDatabaseInfo() {
        ...
        Cursor cursor = db.query(PetEntry.TABLE_NAME,
            ...
            try {
                ...
                int breedCoumnIndex = cursor.getColumnIndex(PetEntry.COLUMN_PET_BREED);
                ...
                while (cursor.moveToNext()) {
                    ...
                    int currentID = cursor.getInt(idColumnIndex);
                     String currentBreed = cursor.getString(breedCoumnIndex);
    ...
    protected void onStart() {
        super.onStart();
//       Toast toast =  Toast.makeText(CatalogActivity.this,Toast.LENGTH_SHORT);
        displayDatabaseInfo();
    }
